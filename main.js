const translations = {
    hu: {
        ...
        frontend12:" A <strong class='blue'>2025-ös könyvespolcom</strong> egy igazi szerelemprojekt. Az olvasás a legfőbb hobbim. Előfordul persze, hogy olyan könyv kerül a kezembe, ami nem nyeri el a tetszésemet – ilyenkor megválok tőle. Ugyanakkor mindig jó érzés visszanézni, mely könyveket olvastam az adott évben, ezért úgy döntöttem, készítek egy online könyvespolcot, ahol nemcsak a könyveket gyűjthetem, hanem a róluk írt véleményeimet is.",
        frontend13:"A könyvekre kattintva olyan hatást keltenek, mintha <strong class='blue'>kihúznánk őket a polcról</strong>, majd egy felugró ablakban rövid értékelés is elolvasható róluk.",
        frontend14:"Mivel a frontend mellett, a grafika is közel áll a szívemhez, mindegyik könyv gerincének letisztult, egyszerűbb változatát <strong class='blue'>én készítettem el Illustratorban.</strong>",
        frontend15: "Még nincs 100%-ban kész.",
        konyvespolc: "2025-ös könyvespolcom",
...
frontend12:"<strong class='blue'>My Bookshelf of 2025</strong> is truly a passion project.  Reading is my biggest hobby. Of course, there are times when I come across a book that I don’t like, and in those cases, I usually pass it on to someone else.  Still, I always love looking back at the books I’ve read this year, so I decided to create an online bookshelf where I can not only collect the books but also share my thoughts and reviews about them.",
frontend13:"When clicking on the books, they give the impression of being <strong class='blue'>pulled out from the shelf</strong>,  and a short review can then be read in a pop-up window.",
frontend14:"Since graphic design is just as close to my heart as frontend development, I created the clean, simplified version of each book spine <strong class='blue'>myself in Illustrator.</strong>",
frontend15:"It’s not 100% finished yet.",
konyvespolc:"My Bookshelf of 2025",
